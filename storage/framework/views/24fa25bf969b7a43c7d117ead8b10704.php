...
<body>
    <div class="container">
        ...
        <div class="field">
            ...
            <div class="value"><a href="mailto:<?php echo e($email); ?>"><?php echo e($email); ?></a></div>
        </div>

        <div class="field">
            <div class="label">Message</div>
            <div class="message-box"><?php echo e($contactMessage); ?></div>
        </div>
...
<?php /**PATH /var/www/html/resources/views/emails/contact-notification.blade.php ENDPATH**/ ?>